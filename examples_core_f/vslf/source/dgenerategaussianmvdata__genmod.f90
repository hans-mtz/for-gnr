        ...
        MODULE DGENERATEGAUSSIANMVDATA__genmod
          INTERFACE 
            FUNCTION DGENERATEGAUSSIANMVDATA(DIM,N,X,A,C)
              ...
              REAL(KIND=4) :: DGENERATEGAUSSIANMVDATA
            END FUNCTION DGENERATEGAUSSIANMVDATA
          END INTERFACE 
        END MODULE DGENERATEGAUSSIANMVDATA__genmod
